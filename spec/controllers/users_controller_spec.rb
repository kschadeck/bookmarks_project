  ...
  before(:each) do
    ...
    describe "GET 'index'" do
      ...
      it "should paginate users" do
        ...
        response.should have_selector("span.disabled", :contenet => "Previous")
      ...
      describe "success" do
        before(:each) do
          @attr = { :name => "New Name", :email => "user@example.org",
                    :password => "barbazbar", :password_confirmation => "barbazbar" }
        end
    ...
    describe "authentication of edit/update pages" do
      ...
      describe "for signed-in users" do
        before(:each) do
          ...
          test_sign_in(worong_user)
        end
        it "should require mataching users for 'edit'" do
          get :edit, :id => @user
    ...
    describe "DELETE 'destroy'" do
      ...
      describe "as an admin user" do
        ...
        it "should redirect to the users page" do
          delete :destroy, :id => @user
          response.should reidrect_to(users_path)
        end
      end
    end
  end
